...
import express.dataService_Driver.StrategyDataService_Driver;
...
public class Server {
	public static void main(String[] args) {
		...
		StrategyDataService strservice = new StrategyDataService_stub();
		StrategyDataService_Driver strdriver = new StrategyDataService_Driver();
		strdriver.drive(strservice);
		
		BankAccountDataService bankAccountDataService=new BankAccountDataService_stub(null, null, null, 0);
		...
		StatisticsDataService statisticsDataService=new StatisticsDataService_stub(null, null, null, null);
		StatisticsDataService_Driver statisticsData=new StatisticsDataService_Driver();
		statisticsData.drive(statisticsDataService);
