...
//		textArea1.setWrapStyleWord(true);// 激活断行不断字功能
		...
		JTextField textArea2 = new JTextField("航班号");
...
//		textArea2.setWrapStyleWord(true);
		...
		JTextField textArea3 = new JTextField("出发地");
...
//		textArea3.setWrapStyleWord(true);
		...
		JTextField textArea4 = new JTextField("到达地");
...
//		textArea4.setWrapStyleWord(true);
		...
		JTextField textArea5 = new JTextField("货柜号");
...
//		textArea5.setWrapStyleWord(true);
		...
		JTextField textArea6 = new JTextField("监装员");
...
//		textArea7.setBackground(Color.BLUE);
		...
		JTextField textArea8 = new JTextField("运费");
