...
public class OrderPO implements Serializable{
	...
	public void setSenderInfo(String senderName,String senderAddress,
			...
			String senderTelephoneNum){   //设置寄件人信息
	...
	public void setReceiverInfo(String receiverName,String receiverAddress,
			...
			String receiverTelephoneNum){   //设置收件人信息
	...
	//设置货物信息
	public void setGoodsInfo(int numberOfGoods,double weight,double volume,String nameOfGoods,DeliveryType type){
